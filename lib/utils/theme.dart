...
/*
* primary color
* primary color is the color of the background
* Secondary color is the overcast color
* icon color is the color of icon
* onPrimary color is the color of object on primary color
* onSecondary color is the color of object on secondary color
* */
